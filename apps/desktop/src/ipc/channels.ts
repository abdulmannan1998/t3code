...
export const NOTIFICATION_SUPPORT_CHANNEL = "desktop:notifications:get-support";
export const NOTIFICATION_SHOW_CHANNEL = "desktop:notifications:show";
export const NOTIFICATION_ACTIVATED_CHANNEL = "desktop:notifications:activated";
